...
namespace AlphaHotel.Data.Migrations
{
    ...
    [Migration("20190605211208_AddedFeedbackAuthorLength")]
    partial class AddedFeedbackAuthorLength
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlphaHotel.Models.Business", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CoverPicture = "marinela-sofia.jpg",
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CoverPicture = "metropolitan-hotel-sofia.jpg",
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("AlphaHotel.Models.BusinessesFacilities", b =>
                {
                    ...
                    b.HasKey("BusinessId", "FacilityId");

                    b.HasIndex("FacilityId");

                    b.ToTable("BusinessesFacilities");
            ...
            modelBuilder.Entity("AlphaHotel.Models.Facility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AlphaHotel.Models.BusinessesFacilities", b =>
                {
                    b.HasOne("AlphaHotel.Models.Business", "Business")
                        .WithMany("BusinessesFacilities")
                        .HasForeignKey("BusinessId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("AlphaHotel.Models.Facility", "Facility")
                        .WithMany("BusinessesFacilities")
