...
{
    [TestClass]
    public class BusinessLogbooks_Should
    {
        [TestMethod]
        public async Task CallBusinessServiceOnce()
        {
            ...
            await businessController.BusinessLogbooks(id);
        ...
        public async Task ReturnCorrectViewModel()
        {
            ...
            var result = await businessController.BusinessLogbooks(id) as PartialViewResult;

            Assert.AreEqual(result.ViewName, "_BusinessLogBooksPartial");
        }
    }
}
