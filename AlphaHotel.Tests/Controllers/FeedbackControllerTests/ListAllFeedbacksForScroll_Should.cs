...
{
    [TestClass]
    public class ListAllFeedbacksForScroll_Should
    {
        [TestMethod]
        public async Task CallFeedbackServiceOnce()
        {
            ...
            await feedbackController.ListAllFeedbacksForScroll(businessId, pageNumber);
        ...
        public async Task ReturnCorrectViewModel()
        {
            ...
            var result = await feedbackController.ListAllFeedbacksForScroll(businessId, pageNumber) as PartialViewResult;

            Assert.AreEqual(result.ViewName, "_AllFeedbacks");
        }
    }
}
